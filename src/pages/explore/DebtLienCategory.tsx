...
import { lienInvestments } from "@/data/investmentTypes";
import { InvestmentTypeCard } from "@/components/debt/InvestmentTypeCard";
import Breadcrumbs from "@/components/Breadcrumbs";

export default function DebtLienCategory() {
      ...
      <main className="px-4 py-6 space-y-6">
        ...
        <div className="glass-card rounded-2xl p-5">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                {lienInvestments.length} investment types
              </p>
            </div>
          </div>
          <p className="text-sm text-muted-foreground">
            Lien investments are secured by real property or other assets. 
            Sponsors acquire lien positions and manage the collection process, whether through redemption, 
            foreclosure, or other legal means. These investments offer varying levels of security based on lien position.
          </p>
        </div>
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="glass-card rounded-xl p-3 text-center">
            ...
            <p className="text-lg font-bold text-primary">8-25%</p>
            <p className="text-xs text-muted-foreground">annualized</p>
          </div>
          <div className="glass-card rounded-xl p-3 text-center">
            <p className="text-xs text-muted-foreground mb-1">Duration</p>
            <p className="text-lg font-bold text-foreground">3 months</p>
            <p className="text-xs text-muted-foreground">to 3 years</p>
          </div>
          <div className="glass-card rounded-xl p-3 text-center">
            <p className="text-xs text-muted-foreground mb-1">Security</p>
            <p className="text-lg font-bold text-green-400">Asset</p>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 gap-4">
            {lienInvestments.map((investment) => (
        ...
        <div className="glass-card rounded-2xl p-5 border border-primary/20">
          ...
          <p className="text-sm text-muted-foreground mb-4">
            Have lien investment opportunities you'd like to list on our platform? 
