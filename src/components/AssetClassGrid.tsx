...
const equityAssets: AssetClass[] = [
  ...
  { id: "gold", icon: "🥇", name: "Gold & Commodities", value: "$500M", subtitle: "Coming Q3 2025", isLive: false, launchDate: "Q3 2025", waitlistId: "gold_commodities" },
  { id: "private", icon: "🏭", name: "Private Business", value: "$320M", subtitle: "Coming Q1 2026", isLive: false, launchDate: "Q1 2026", waitlistId: "private_business" },
  { id: "startups", icon: "🚀", name: "Startups & VC", value: "$180M", subtitle: "Coming Q3 2026", isLive: false, launchDate: "Q3 2026", waitlistId: "startups_vc" },
...
const debtAssets: AssetClass[] = [
  ...
  { id: "business", icon: "💼", name: "Business Loans", value: "$95M", subtitle: "Coming Q1 2026", isLive: false, launchDate: "Q1 2026", waitlistId: "private_business" },
              ...
              <div className="flex flex-col items-end gap-1">
                {asset.isLive ? (
                  ...
                  <span className="px-2 py-0.5 rounded-full text-[10px] font-medium bg-muted text-muted-foreground">
                    {asset.launchDate || "Soon"}
                  </span>
                )}
                {!asset.isLive && waitlistCount > 0 && (
                  <span className="flex items-center gap-0.5 text-[9px] text-muted-foreground">
                    <Users className="w-2.5 h-2.5" />
                    {formatWaitlistCount(waitlistCount)} waiting
                  </span>
                )}
              </div>
            </div>
