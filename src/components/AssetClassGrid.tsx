...
const equityAssets: AssetClass[] = [
  ...
  { id: "gold-crypto-commodities", icon: "🥇", nameKey: "assets.goldCryptoCommodities", value: "$1.9B", subtitle: "Coming Q2 2026", isLive: false, launchDate: "Q2 2026", waitlistId: "gold_commodities" },
